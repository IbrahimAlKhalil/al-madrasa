...
INSERT INTO "public"."directus_fields" VALUES (13, 'institute', 'db_name', NULL, 'input', '{"iconLeft":"storage","placeholder":"DB Name","trim":true}', NULL, NULL, true, false, 13, 'full', NULL, NULL, NULL, false, NULL);
...
SELECT pg_catalog.setval('"public"."directus_permissions_id_seq"', 172, true);
