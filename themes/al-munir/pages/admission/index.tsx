...
const Admission: NextPage<PageProps> = (props) => {
    ...
    const submit: FormEventHandler<HTMLFormElement> = async (evt) => {
        ...
        // TODO: Insert data into sql server database
                            ...
                            <div className="tab-pane fade show active" id="new" role="tabpanel"
                                ...
                                <form method="post" className="php-email-form" onSubmit={submit}>
                                    <div className="row gy-4">
                                        ...
                                        <div className="col-md-6 form-group">
                                            <label htmlFor="abasikAnabasik">আবাসিক / অনাবাসিক / ডে-কেয়ার</label>
                                        ...
                                        <div className="col-md-6">
                                            <input
                                                placeholder="জাতিয় পরিচয়পত্রের নাম্বার"
                                                className="form-control"
                                                type="text"
                                                name="nid"
                                                required
                                        ...
                                        <div className="col-md-12 text-center">
                                            {
                                                status === 'loading' ? <div className="loading">লোড হচ্ছে</div> : null
                                            }

                                            {
                                                status === 'error' ? (
                                                    <div className="error-message">
                                                        ক্রিটিক্যাল সমস্যার জন্য আবেদন করা সম্ভব হচ্ছেনা, দয়া করে কিছুক্ষন পর
                                                        আবার চেষ্টা করুন
                                                    </div>
                                                ) : null
                                            }
                                            ...
                                            {
                                                status === 'success' ? <div className="sent-message">আবেদন সফল!</div> : null
                                            }
...
export const getServerSideProps = getServerSidePageProps(['general'], async (props, ctx) => {
