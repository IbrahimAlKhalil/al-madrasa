    ...
    return (
        <div className="col-lg-3 col-md-6">
            <div className="count-box">
                <i className="mi" style={style as any}>{props.icon}</i>
                <div>
                    <span data-purecounter-start={0} data-purecounter-end={props.count}
        ...
        <section id="counts" className="counts">
            <div className="container" data-aos="fade-up">
                <div className="row gy-4">
                    {
                        data.counts.map((count: CountInterface) => <Count {...count} key={count.title}/>)
                    }
                </div>
            </div>
        </section>
