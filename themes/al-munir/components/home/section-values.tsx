    ...
    return (
        <div className="col-lg-4 mt-4 mt-lg-0 pt-4">
            <div className="box" data-aos="fade-up" data-aos-delay={200}>
                <img src={`/assets/${props.image}`} className="img-fluid" alt=""/>
                <h3>{props.title}</h3>
...
export const SectionValues: FunctionComponent<SectionProps> = (props) => {
    ...
    const items: ValueInterface[] = data && Array.isArray(data.items) ? data.items: [];
    ...
    return (
        <section id="values" className="values">
            <div className="container" data-aos="fade-up">
                ...
                <div className="row">
                    {
                        items.map(item => <Value {...item} key={item.title}/>)
                    }
                </div>
            </div>
        </section>
