...
export const SectionContact: FunctionComponent<SectionProps> = (props) => {
    ...
    const [questionTypes, loadQuestionTypes] = useState<{id: number, name: string}[]>([]);
            ...
            <div className="container" data-aos="fade-up">
                ...
                <div className="row gy-4">
                    ...
                    <div className="col-lg-6">
                        <div className="row gy-4">
                            {
                                data.tiles.map((tile: TileInterface) => <Tile key={tile.title} {...tile} />)
                            }
                        </div>
                    </div>
                        ...
                        <form method="post" className="php-email-form" onSubmit={submit}>
                            <div className="row gy-4">
                                ...
                                <div className="col-md-12">
                                    <select
                                        onInput={(evt) => changeQuestionType(evt.currentTarget.value)}
                                        className="form-control"
                                        value={questionType}
                                        name="questionType"
                                        placeholder="ধরন"
                                ...
                                <div className="col-md-12 text-center">
...

                                    {
                                        status === 'error' ? (
                                            <div className="error-message">
                                                ক্রিটিক্যাল সমস্যার জন্য মেসেজ পাঠানো সম্ভব হচ্ছেনা, দয়া করে কিছুক্ষন পর
                                                আবার চেষ্টা করুন
                                            </div>
                                        ) : null
                                    }
                                    ...
                                    {
                                        status === 'success' ? <div className="sent-message">আমরা আপনার মেসেজটি পেয়েছি.
                                            ধন্যবাদ!</div> : null
                                    }
