...
export function ConvertToASCII(text: string, target = "bijoy"): string {
    const conversionMap: ConversionMap = target === 'bijoy' ? uniToBijoyMap : target === 'somewherein' ? uniToSomewhereinMap : uniToBaishakhiMap;

    text = text.replace(new RegExp("ো", "g"), "ো");
    text = text.replace(new RegExp("ৌ", "g"), "ৌ");
