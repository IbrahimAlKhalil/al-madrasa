<template>
	...
	<v-menu ref="contextMenu" show-arrow placement="bottom-start">
		<v-list>
			<v-list-item clickable :to="`/_settings/${collection.collection}?archive`" exact query>
				<v-list-item-icon>
...
export default defineComponent({
	...
	setup(props) {
		...
		const to = computed(() => (props.collection.schema ? `/_settings/${props.collection.collection}` : ''));
